...
//        }
    ...
    public void onBindViewHolder(SearchViewHolder viewHolder, int position) {
       ...
       viewHolder.mEmployeeNameBN.setText(mSearchItemList.get(position).getEmpNameBN());
...
//        }
    ...
    public class SearchViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private TextView mEmployeeNameBN;
        ...
        public SearchViewHolder( View itemView) {
            ...
            mEmployeeNameBN=itemView.findViewById(R.id.s_employee_bagla);
